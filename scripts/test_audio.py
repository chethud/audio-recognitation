...
def main() -> None:
    ...
    result = run_alm_lite(
        ...
        sed_top_k=sed.get("top_k", 10),
        sed_threshold=sed.get("threshold", 0.04),
        sed_segment_sec=sed.get("segment_sec", 2.5),
        sed_max_windows=sed.get("max_windows", 12),
        sed_max_results=sed.get("max_results", 12),
        sed_backend=sed.get("backend", "hybrid"),
